defmodule ElixirLearningAppWeb.Router do
  ...
  import ElixirLearningAppWeb.UserAuth
  ...
  scope "/", ElixirLearningAppWeb do
    ...
    live_session :redirect_if_user_is_authenticated,
      on_mount: [{ElixirLearningAppWeb.UserAuth, :redirect_if_user_is_authenticated}] do
  ...
  scope "/", ElixirLearningAppWeb do
    ...
    live_session :require_authenticated_user,
      on_mount: [{ElixirLearningAppWeb.UserAuth, :ensure_authenticated}] do
  ...
  scope "/", ElixirLearningAppWeb do
    ...
    live_session :current_user,
      on_mount: [{ElixirLearningAppWeb.UserAuth, :mount_current_user}] do
